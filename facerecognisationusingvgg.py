...
#flowers_vgg.h5
checkpoint = ModelCheckpoint("myfacerecog.h5",
                             monitor="val_loss",
                             mode="min",
                             save_best_only = True,
                             verbose=1)
...
classifier = load_model('myfacerecog.h5')
...
monkey_breeds_dict = {"[0]": "divyaraj", 
                      }

monkey_breeds_dict_n = {"divyaraj": "divyaraj", 
                      }
